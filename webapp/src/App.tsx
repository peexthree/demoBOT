      ...
      <div className="p-6 -mt-2">
        ...
        {activeTab === 'analytics' && (
          ...
          >
            ...
            <div className="bg-[#1c1c1e] rounded-[20px] p-6 border border-white/5 shadow-sm">
                ...
                <div className="text-4xl font-semibold tracking-tight">₽ 1,284,500</div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <StatBlock icon={<Users size={18} />} title="Новые лиды" value="142" />
            ...
            <div className="bg-gradient-to-br from-[#0a84ff] to-[#0056b3] rounded-[20px] p-6 text-white shadow-lg relative overflow-hidden mt-4">
                ...
                <button className="bg-white text-[#0a84ff] px-4 py-2 rounded-full text-sm font-semibold flex items-center shadow-sm hover:scale-105 transition-transform">
        ...
        {activeTab === 'crm' && (
          ...
          >
             ...
             <button className="w-full mt-6 py-4 bg-[#2c2c2e] hover:bg-[#3c3c3e] border border-white/10 rounded-[14px] text-white font-medium flex items-center justify-center gap-2 transition-all shadow-sm">
               <Briefcase size={18} />
...
function LeadRow({ name, action, time, amount, status }: { name: string, action: string, time: string, amount: string, status: 'new' | 'active' | 'completed' }) {
  ...
  return (
    <div className="p-4 flex items-center gap-4 hover:bg-[#2c2c2e] transition-colors cursor-pointer">
